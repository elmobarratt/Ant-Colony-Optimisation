...
beta = 0.5        # Parameter for controlling the influence of desirability in probability updating rule
rho = 0.1       # Parameter in interval (0,1) referred to as evaporation of pheromone constant

NodePop = 20     # Total number of Nodes on the graph
...
plt.plot([Nodes[optimalWalkHistory[-1][i]].position[0] for i in range(NodePop)],[Nodes[optimalWalkHistory[-1][i]].position[1] for i in range(NodePop)])
